...
public final class DAI_EntityBehaviorVocabulary {
    ...
    private static final Set<String> ACTIONS = Set.of(
            ...
            "avoid_player",
            "wander",
            "function", "run_function", "server_run_function",
            "command", "run_command", "server_command",
            "projectile_spawn", "server_projectile_spawn",
            "particle_emit", "server_particle_emit",
            "effect_apply", "server_effect_apply",
            "effect_remove", "server_effect_remove",
            "potion_apply", "server_potion_apply",
            "content_event", "emit_content_event",
            "wait",
            "idle",
            "noop"
    );
