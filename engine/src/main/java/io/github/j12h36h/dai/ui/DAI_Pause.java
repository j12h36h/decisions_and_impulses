...
public class DAI_Pause extends Screen {
    ...
    public DAI_Pause(boolean showPauseMenu) {
    ...
    private void createPauseMenu() {
        ...
        helper.addChild(Button.builder(RETURN_TO_GAME, button -> {
            this.minecraft.gui.setScreen(new DAI_Menu());
        ...
        if (integratedServer != null && this.minecraft.player != null) {
            List<Map.Entry<UUID, PlayerInfo>> list = this.minecraft
                    .player
                    .connection
                    .getSeenPlayers()
                    .entrySet()
